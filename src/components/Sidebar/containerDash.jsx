...
const ContainerDash = () => {
  return (
    <section className={Styles.containerVentas} style={{display:"flex", flexDirection:"column", height:"850px"}}>
      ...
      <div style={{width:"75vw", height:"400px  ", display:"flex", flexDirection:"row",boxShadow:"0 0 10px rgba(0, 0, 0, 0.5)"}}>
        <div style={{width:"55vw", display:"flex",boxShadow:"0 0 10px rgba(0, 0, 0, 0.5)", padding:"0.5vh 1vw",}}>
          <ChartEarningYear />
          <ChartEarningMonth />
          <ChartEarningDay />
        </div>
